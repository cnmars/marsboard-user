...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from '/root/src/v2board-user/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from '/root/src/v2board-user/node_modules/@umijs/plugin-locale/node_modules/warning/warning.js';
...
import lang_enUS0 from "/root/src/v2board-user/src/locales/en-US.ts";
import viVN0 from 'antd/es/locale/vi_VN';
import lang_viVN0 from "/root/src/v2board-user/src/locales/vi-VN.ts";
import zhCN0 from 'antd/es/locale/zh_CN';
import lang_zhCN0 from "/root/src/v2board-user/src/locales/zh-CN.ts";
