// @ts-nocheck
/**
 * Base on https://github.com/umijs//root/src/v2board-user/node_modules/umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from '/root/src/v2board-user/node_modules/umi-request';
// @ts-ignore
...
import useUmiRequest, { UseRequestProvider } from '/root/src/v2board-user/node_modules/@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from '/root/src/v2board-user/node_modules/@ahooksjs/use-request/lib/types';
